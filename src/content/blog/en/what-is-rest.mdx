---
title: 'What is REST?'
description: 'Learn all about REST, RESTful architecture and its 6 guiding principles.'
date: '2022-07-02'
pubDate: 'Jul 02 2022'
image: /Blog/images/prompthero-prompt-6c4739896ef.webp
tags:
  - REST
  - Architecture
  - "Web Development"
...
---
# What Is REST
REST is an acronym for REpresentational State Transfer and an architectural style for distributed hypermedia systems. Roy Fielding first presented it in 2001 in his famous [dissertation](https://www.ics.uci.edu/~fielding/pubs/dissertation/rest_arch_style.htm).
...
Multiple architectural constraints help in obtaining a uniform interface and guiding behavior of components.
...
## 1.2. Client-Server
The client-server design patterns enforces the separation of concerns, which helps the client and the server components evolve independently.
...
A RESTful API looks like *hypertext*. Every addressable unit of information carries an address either explicitly (e.g.: link and id attributes) or implicitly (e.g: derived from media type definition and representation structure).

>Hypertext (or hypermedia) means the simultaneous presentation of information and controls such that the information becomes affordance through which the user (or automaton) obtains choices and select actions.
...
Roy Fielding, in his dissertation, has nowhere mentioned any implementation direction — including any protocol preference or even HTTP. Till the time, we are honoring the six guiding principles of REST, which we can call out interface — RESTful.
# 5. Summary
